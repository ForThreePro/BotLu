let handler = async (m, { conn, participants, groupMetadata, command }) => {
    ...
    if (command === 'gdc' || command === 'guerradeclanes' || command === 'guerra') {
        ...
        let text = `╭─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─╮
  🐾 𝗚𝗨𝗘𝗥𝗔 𝗗𝗘 𝗖𝗟𝗔𝗡𝗘𝗦 🐾
╰─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─╯
...
> 😼 *Bot Lu*`.trim()
    ...
    let plantilla = `╭─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─╮
  😼 𝗧𝗘𝗔𝗠 𝗡𝗜𝗚𝗛𝗧𝗪𝗜𝗦𝗛 😼
╰─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─╯
...
╭─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─╮
│🐱 𝗧𝗜𝗧𝗨𝗟𝗔𝗥𝗘𝗦
${listaTitulares}╰─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─╯

╭─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─╮
│💕 𝗦𝗨𝗣𝗟𝗘𝗡𝗧𝗘𝗦
${listaSuplentes}╰─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─ׅ─╯
