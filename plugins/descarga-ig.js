...
let handler = async (m, { conn, text, command, usedPrefix }) => {
    if (!text) return conn.reply(m.chat, `╭─🐱 *『 𝐁𝐎𝐓 𝐋𝐔 』* 🐱
...
│
│ > *“Extrayendo con patitas digitales”* 🐾
╰─────────────────❒`
...
│ 📅 *Fecha:* ${date}
│
│ > *“Archivo guardado en la nube de Lu”* 🐾
╰─────────────────❒`
